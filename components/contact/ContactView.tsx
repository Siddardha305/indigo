    ...
    <div className="w-full bg-white font-el-messiri overflow-hidden">
      ...
      <section className="w-full py-12 md:py-16 flex flex-col items-center bg-white px-4">
          <div className="max-w-[1100px] w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative p-6 md:p-8 border border-[#DFAB40]/30 rounded-2xl overflow-hidden bg-white shadow-sm">
                  ...
                  <div className="relative z-10 flex flex-col items-center">
                    <h3 className="text-[#20064A] text-xl md:text-2xl font-serif mb-2 uppercase tracking-wide">Let&apos;s Connect</h3>
                    ...
                    <form className="w-full flex flex-col gap-3.5">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
                            <div className="flex flex-col gap-1.5">
                                ...
                                <input type="text" placeholder="John Doe" className="w-full bg-[#fdf8ec] border border-[#DFAB40]/10 px-4 py-2.5 rounded-md text-[#20064A] text-sm focus:outline-none focus:border-[#DFAB40]/40" />
                            </div>
                            <div className="flex flex-col gap-1.5">
                                <label className="text-[#20064A] text-[9px] font-bold uppercase tracking-widest pl-1">Phone</label>
                                <input type="text" placeholder="9887711223" className="w-full bg-[#fdf8ec] border border-[#DFAB40]/10 px-4 py-2.5 rounded-md text-[#20064A] text-sm focus:outline-none focus:border-[#DFAB40]/40" />
                            </div>
                        </div>
                        
                        <div className="flex flex-col gap-1.5">
                            <label className="text-[#20064A] text-[9px] font-bold uppercase tracking-widest pl-1">Email Address</label>
                            <input type="email" placeholder="you@example.com" className="w-full bg-[#fdf8ec] border border-[#DFAB40]/10 px-4 py-2.5 rounded-md text-[#20064A] text-sm focus:outline-none focus:border-[#DFAB40]/40" />
                        </div>
                        
                        <div className="flex flex-col gap-1.5">
                            <label className="text-[#20064A] text-[9px] font-bold uppercase tracking-widest pl-1">Subject</label>
                            <input type="text" placeholder="General Inquiry" className="w-full bg-[#fdf8ec] border border-[#DFAB40]/10 px-4 py-2.5 rounded-md text-[#20064A] text-sm focus:outline-none focus:border-[#DFAB40]/40" />
                        </div>
                        
                        <div className="flex flex-col gap-1.5">
                            <label className="text-[#20064A] text-[9px] font-bold uppercase tracking-widest pl-1">Message</label>
                            <textarea rows={3} placeholder="Type here..." className="w-full bg-[#fdf8ec] border border-[#DFAB40]/10 px-4 py-2.5 rounded-md text-[#20064A] text-sm focus:outline-none focus:border-[#DFAB40]/40 resize-none" />
                        </div>

                        <button type="button" className="w-full bg-[#20064A] text-white py-3.5 mt-2 rounded-md font-bold text-xs uppercase tracking-[0.2em] flex items-center justify-center gap-3 hover:bg-[#300a6e] transition-all">
                            Send Now
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="rotate-45"><path d="M5 12h14m-7-7l7 7-7 7"/></svg>
                        </button>
                    </form>
