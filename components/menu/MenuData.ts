...
export const MENU_DATA: Record<string, MenuItem[]> = {
  "BREAKFAST": [
    { id: "bf1", name: "Goat Keema", description: "Minced goat meat cooked with traditional spices.", price: "19.99", category: "BREAKFAST" },
  ...
  "APPETIZERS": [
    { id: "ap1", name: "Dry Chilli Paneer", description: "Crispy cottage cheese tossed with bell peppers and fresh chilies in a flavorful Indo-Chinese sauce.", price: "14.99", category: "APPETIZERS", isVegetarian: true },
    ...
    { id: "ap3", name: "Veg Samosa (2 pcs)", description: "Crispy pastry filled with spiced potatoes, served with mint and tamarind chutney.", price: "4.99", category: "APPETIZERS", isVegetarian: true },
    ...
    { id: "ap8", name: "Chicken Lollipop", description: "Juicy chicken wings, deep-fried and marinated in spices, dipped in a flavorful sauce.", price: "15.99", category: "APPETIZERS", isSpicy: true },
    ...
    { id: "ap20", name: "Chicken Boti", description: "Tender chicken cubes marinated in Indian spices, sautéed with onions and bell peppers.", price: "11.99", category: "APPETIZERS" },
    ...
    { id: "ap24", name: "Bombay Grill Fish", description: "Whole Pampano fish marinated in aromatic Bombay spices, grilled to perfection.", price: "19.99", category: "APPETIZERS" },
  ...
  "CURRIES": [
    { id: "cr1", name: "Goat Korma", description: "Bone-in goat cooked with onions and yogurt in a lightly spiced brown gravy. Served with white rice.", price: "19.99", category: "CURRIES" },
    ...
    { id: "cr3", name: "Goat Keema", description: "Minced goat meat cooked with onions, garlic, ginger, and tomatoes. Served with white rice.", price: "19.99", category: "CURRIES" },
    ...
    { id: "cr6", name: "Butter Chicken (Boneless)", description: "Tender boneless BBQ chicken in a creamy tomato-butter sauce. Served with white rice.", price: "16.99", category: "CURRIES" },
    { id: "cr7", name: "Chicken Handi", description: "Whole bone-in chicken pieces slow-cooked with onions, yogurt, and traditional spices. Served with white rice.", price: "16.99", category: "CURRIES" },
    ...
    { id: "cr11", name: "Chicken Korma", description: "Tender chicken marinated in yogurt and slow cooked with onions and aromatic spices. Served with white rice.", price: "16.99", category: "CURRIES" },
  ...
  "BREADS": [
    { id: "br1", name: "Butter Naan", description: "Freshly baked naan bread with butter on top.", price: "2.99", category: "BREADS", isVegetarian: true },
    { id: "br2", name: "Garlic Naan", description: "Naan bread with butter, garlic, and cilantro.", price: "3.99", category: "BREADS", isVegetarian: true },
  ...
  "DESSERTS": [
    { id: "ds1", name: "Carrot Halwa", description: "A sweet dessert made with grated carrots, milk, sugar, and garnished with nuts.", price: "5.99", category: "DESSERTS", isVegetarian: true },
    { id: "ds2", name: "Ras Malai", description: "Soft cheese dumplings soaked in sweet, creamy milk and garnished with nuts.", price: "6.99", category: "DESSERTS", isVegetarian: true },
  ...
  "BEVERAGES": [
    ...
    { id: "bv4", name: "Mango Lassi", description: "Refreshing, creamy yogurt drink with a rich mango flavor.", price: "5.99", category: "BEVERAGES" },
    ...
    { id: "bv11", name: "Chai", description: "Hot tea made with cow’s milk, served warm.", price: "2.99", category: "BEVERAGES" }
  ]
};
...
export const SPECIALS_DATA = [
  ...
  { id: "s2", name: "GOAT KORMA", description: "Traditional bone-in goat cooked to perfection.", image: "/menu/goat-korma.png" },
  { id: "s3", name: "SAMOSA CHAAT", description: "A tangy, spicy, and sweet explosion of flavors.", image: "/menu/samosa-chaat.png" },
  { id: "s4", name: "MANGO LASSI", description: "The sweetness of mango and yogurt in every sip.", image: "/menu/mango-lassi.png" }
];
